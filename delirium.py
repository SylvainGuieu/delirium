...
class Delirium(object, DataUtils):
    ...
    def __init__(self, sensors, filepath=None):
        ...
        self.f = open(filepath) if filepath else None
    ...
    def reload(self):
        self.f = open(self.filepath) if self.filepath else None
        self.data = None    
        self.load_data()
    ...
    def load_header(self):
        ...
        while True:
            ...
            for var, search in  self.header_lookup.iteritems():
    ...
    def load_data(self):
        ...
        The check are set thanks to the data_check dictionary attribute:
            ...
            'sample' : check if the data is well sampling
